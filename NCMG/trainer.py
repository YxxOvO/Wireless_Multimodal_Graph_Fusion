...
class Trainer(object):
    ...
    def channel_gain(self,f,int_samp,power,phase,bs,dist_ur,dist_ub,ang_ur,ang_ub,batch,ang_uBR):
        ...
        #h_rb=alpha_br*((math.sqrt(self.args.get("Rician_factor")/(1+self.args.get("Rician_factor"))))*outer_br)+(math.sqrt(1/(1+self.args.get("Rician_factor"))))*torch.randn(batch,self.args.get("sub_bands"),int_samp,self.args.get("BS_antenna"),self.args.get("IRS_elements")).to(device)
        ...
        #h_ur=alpha_ur*((math.sqrt(self.args.get("Rician_factor")/(1+self.args.get("Rician_factor"))))*a_ur)+(math.sqrt(1/(1+self.args.get("Rician_factor"))))*torch.randn(batch,self.args.get("sub_bands"),int_samp,self.args.get("num_users"),self.args.get("IRS_elements")).to(device)
        ...
        #h_ub=alpha_ub*((math.sqrt(self.args.get("Rician_factor")/(1+self.args.get("Rician_factor"))))*a_ub)+(math.sqrt(1/(1+self.args.get("Rician_factor"))))*torch.randn(batch,self.args.get("sub_bands"),int_samp,self.args.get("num_users"),self.args.get("BS_antenna")).to(device)
    ...
    def val_epoch(self, epoch, val_dataloader):
        ...
        with torch.no_grad():
            for batch_idx, (x_visual, x_wireless) in enumerate(val_dataloader):
                #data = data[..., :self.args.get('input_dim')]
                #label = target[..., :self.args.get('output_dim')]
                batch=x_wireless.size()[0]
                
                user=x_wireless.size()[1]
                
                x_user=x_wireless[:,0:self.args.get("num_users")*self.args.get("feature_user")]
                
                x_user=torch.reshape(x_user,[batch,self.args.get("num_users"),self.args.get("feature_user")])
                
                
                
                x_bs=x_wireless[:,self.args.get("num_users")*self.args.get("feature_user"):self.args.get("num_users")*self.args.get("feature_user")+self.args.get("feature_BS")]
                
                x_bs=torch.reshape(x_bs,[batch,1,self.args.get("feature_BS")])
                
                
                
                x_irs=x_wireless[:,self.args.get("num_users")*self.args.get("feature_user")+self.args.get("feature_BS"):self.args.get("num_users")*self.args.get("feature_user")+self.args.get("feature_BS")+self.args.get("feature_IRS")]
                ...
                ang_ur1=x_wireless[:,ind2:ind2+self.args.get("num_users")*self.args.get("IRS_elements")]
                
                ang_ur=torch.reshape(ang_ur1,[batch,self.args.get("num_users"),self.args.get("IRS_elements")])
                
                
                
                ang_ub1=x_wireless[:,ind2+self.args.get("num_users")*self.args.get("IRS_elements"):ind2+self.args.get("num_users")*self.args.get("IRS_elements")+self.args.get("num_users")*self.args.get("BS_antenna")]
                ...
                dist_ur1=x_wireless[:,ind3:ind3+self.args.get("num_users")]
                
                dist_ur=torch.reshape(dist_ur1,[batch,self.args.get("num_users"),1])
                
                
                dist_ub1=x_wireless[:,ind3+self.args.get("num_users"):ind3+2*self.args.get("num_users")]
                
                dist_ub=torch.reshape(dist_ub1,[batch,self.args.get("num_users"),1])
                
                ind4=ind3+2*self.args.get("num_users")
                
                ang_uBR=x_wireless[:,ind4:ind4+2*self.args.get("num_users")*self.args.get("user_antenna")]
    ...
    def train_epoch(self, epoch):
        ...
        cr_t=0
        cb_t=0
        for batch_idx, (x_visual, x_wireless) in enumerate(self.train_loader):
            #data = data[..., :self.args.get('input_dim')]
    ...
    def test(self):
        ...
        total_sum=[]
        with torch.no_grad():
            for batch_idx, (x_visual, x_wireless) in enumerate(self.test_loader):
                batch=x_wireless.size()[0]
                
                user=x_wireless.size()[1]
                
                x_user=x_wireless[:,0:args.get("num_users")*args.get("feature_user")]
                
                x_user=torch.reshape(x_user,[batch,args.get("num_users"),args.get("feature_user")])
                
                
                
                x_bs=x_wireless[:,args.get("num_users")*args.get("feature_user"):args.get("num_users")*args.get("feature_user")+args.get("feature_BS")]
                
                x_bs=torch.reshape(x_bs,[batch,1,args.get("feature_BS")])
                
                
                
                x_irs=x_wireless[:,args.get("num_users")*args.get("feature_user")+args.get("feature_BS"):args.get("num_users")*args.get("feature_user")+args.get("feature_BS")+args.get("feature_IRS")]
                ...
                ang_ur1=x_wireless[:,ind2:ind2+args.get("num_users")*args.get("IRS_elements")]
                
                ang_ur=torch.reshape(ang_ur1,[batch,args.get("num_users"),args.get("IRS_elements")])
                
                
                
                ang_ub1=x_wireless[:,ind2+args.get("num_users")*args.get("IRS_elements"):ind2+args.get("num_users")*args.get("IRS_elements")+args.get("num_users")*args.get("BS_antenna")]
                ...
                dist_ur1=x_wireless[:,ind3:ind3+args.get("num_users")]
                
                dist_ur=torch.reshape(dist_ur1,[batch,args.get("num_users"),1])
                
                
                dist_ub1=x_wireless[:,ind3+args.get("num_users"):ind3+2*args.get("num_users")]
                
                dist_ub=torch.reshape(dist_ub1,[batch,args.get("num_users"),1])
