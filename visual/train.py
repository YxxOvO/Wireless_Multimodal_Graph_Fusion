...
from dataload import args, train,valid,test
...
model = SeHGNN(args,args.get("num_users"),args.get("feature_user_visual"),1,
                   args.get("feature_BS_visual"),1,args.get("feature_IRS_visual"),
